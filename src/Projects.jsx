        ...
        {/* BODY */}
                ...
                <div className="grid grid-cols-2 items-start gap-12 text-pgray mb-16 font-chivo">
                    ...
                    <div className="h-full pb-4 bg-pdarkgray border border-pdarkgray rounded-lg flex flex-col items-center gap-2 transition ease-in-out duration-300">
                        <img className="scale-90 row-span-1" src="./public/assets/project1.png" alt="Project 1" />
                        ...
                        <div className="flex flex-col gap-2 px-5 w-full">
                            ...
                            <div className="flex flex-wrap items-center justify-start gap-6">                
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/react.svg" alt="React"/>
                                </div>
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/css.svg" alt="CSS"/>
                                </div>
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/express.svg" alt="Express"/>
                                </div>
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/nodejs.svg" alt="NodeJS"/>
                                </div>
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/mongodb.svg" alt="MongoDB"/>
                                </div>
                            </div>
                        </div>
                        <div className="flex gap-2 px-5 w-full items-center justify-start">
                            ...
                            <a href="https://github.com/nilesong/message-board" target="_blank"><img className="h-5 w-5" src="./public/assets/github.svg" alt="Github"/></a>
                        </div>
                    </div>

                    {/* PROJECT 2 */}
                    <div className="h-full pb-4 bg-pdarkgray border border-pdarkgray rounded-lg flex flex-col items-center gap-2 transition ease-in-out duration-300">
                        <img className="scale-90" src="./public/assets/project2.png" alt="Project 2" />
                        <div className="flex flex-col gap-2 px-5 w-full">
                        ...
                        <div className="flex flex-col gap-2 px-5 w-full">
                            ...
                            <div className="flex flex-wrap items-center justify-start gap-6">                
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/html.svg" alt="HTML"/>
                                </div>
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/javascript.svg" alt="Javascript"/>
                                </div>
                                <div className="w-32 h-14 border border-pblack rounded-lg flex items-center justify-center transition ease-in-out duration-300 hover:scale-110">
                                    <img className="h-10 w-10" src="./public/assets/tailwind.svg" alt="Tailwind"/>
                                </div>
                            </div>
                        </div>
                        <div className="flex gap-2 px-5 w-full items-center justify-start">
                            ...
                            <a href="https://github.com/nilesong/weather-app" target="_blank"><img className="h-5 w-5" src="./public/assets/github.svg" alt="Github"/></a>
                        </div>
                    </div>
                </div>
            </div>
