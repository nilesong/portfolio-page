    ...
    return (
        <>
            <div className="grid gap-6 mx-40">
                ...
                <h1 className="text-pteal mt-10">PROJECTS</h1>
                <div className="grid grid-cols-2 gap-12 text-pgray mb-16">
                    <div onClick={handleClick} className="bg-pdarkgray border border-pdarkgray rounded-lg flex flex-col items-center transition ease-in-out duration-300 hover:scale-110">
