                     ...
                     <div className="flex flex-col gap-3 text-pgray">
                        ...
                        <div className="grid grid-rows-2 gap-1">
                            ...
                            <div className="flex gap-3">
                                <a href="https://www.linkedin.com/in/neil-ong-a17a70141" target="_blank"><img className="h-10 w-10" src="./src/assets/linkedin.svg" alt="LinkedIn"/></a>
                                <a href="https://github.com/nilesong" target="_blank"><img className="h-10 w-10" src="./src/assets/github.svg" alt="Github"/></a>
                            </div>
